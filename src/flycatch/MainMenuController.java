...
public class MainMenuController implements Initializable {
    ...
    public void getUser(int userId) {
        ...
        walletLabel.setText("Wallet: " + db.getCardValue(this.userID) + " $");
    }
    ...
    private void wallet(MouseEvent event) {
        ...
        if (db.haveCard(this.userID) == 0) {
            try {
                ...
                controller.getUser(this.userID);
    ...
    @FXML
    private void orderTicket(MouseEvent event) {
        try {
    ...
    @FXML
    private void myFlights(MouseEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("MyFlights.fxml"));
            Parent parent = loader.load();
            MyFlightsController controller = loader.getController();
            controller.getUser(this.userID);
            Scene scene = new Scene(parent);
            Stage stage = new Stage();
            stage.setScene(scene);
        ...
        @FXML
    private void myStats(MouseEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("MyStatistics.fxml"));
            Parent parent = loader.load();
            MyStatisticsController controller = loader.getController();
            controller.getUser(this.userID);
            Scene scene = new Scene(parent);
            Stage stage = new Stage();
            stage.setScene(scene);
